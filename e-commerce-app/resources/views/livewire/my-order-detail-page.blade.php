            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
                <div class="p-4 md:p-5 flex gap-x-4">
                    ...
                    <div class="grow">
                        ...
                        <div class="mt-1 flex items-center gap-x-2">
                            <span class="bg-{{$status}}-500 py-1 px-3 rounded text-white shadow">{{$order->status}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
                <div class="p-4 md:p-5 flex gap-x-4">
                    ...
                    <div class="grow">
                        ...
                        <div class="mt-1 flex items-center gap-x-2">
                            <span class="bg-{{$payment_status}}-500 py-1 px-3 rounded text-white shadow">{{$order->payment_status}}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tr wire:key="{{ $item->id }}">
                            <td class="py-4">
                                <div class="flex items-center">
                                    <img class="h-16 w-16 mr-4" src="{{ url('storage', $item->product->images) }}" alt="Product image">
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Subtotal</span>
                        <span>{{ Number::currency($order->total_price, "USD" ) }}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Taxes</span>
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold">{{ Number::currency($order->total_price, "USD" ) }}</span>
                    </div>
