                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        ...
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                            {{ \Illuminate\Support\Number::currency($order->total_price, "USD") }}</p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            Payment Method: </p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
                            {{ $order->payment_method ==='stripe' ? "Stripe" : "Cash on Delivery" }}</p>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 dark:border-gray-700">
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency($order->total_price, "USD") }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Discount
                                    </p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency(0, "USD") }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">{{ \Illuminate\Support\Number::currency($order->total_price, "USD") }}</p>
                            </div>
                        </div>
