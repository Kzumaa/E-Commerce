                                ...
                                <div class="border border-gray-300 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        <a href="/products/{{$product->slug}}" class="">
                                            <img src="{{ url('storage', $product->images) }}" alt="{{ $product->image }}" class="object-cover w-full h-56 mx-auto ">
                                        </a>
                                    </div>
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{ \Illuminate\Support\Number::currency($product->price, "USD" ) }}</span>
                                        </p>
                                    </div>
